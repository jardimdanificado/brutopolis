...
Uses WagnerAsset format (compatible with wagner.h load_image / WAGNER_ASSETS).
"""
...
if not os.path.isdir(ASSETS_DIR):
    ...
    with open(OUTPUT, "w") as f:
        f.write("#pragma once\n")
        f.write("typedef struct { const char* path; const unsigned char* data; unsigned int size; } WagnerAsset;\n")
        f.write("static const WagnerAsset WAGNER_ASSETS[] = { {0,0,0} };\n")
        f.write("static const int WAGNER_ASSET_COUNT = 0;\n")
    sys.exit(0)
